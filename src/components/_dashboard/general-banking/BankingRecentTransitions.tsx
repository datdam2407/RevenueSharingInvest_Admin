...
const RECENT_TRANSITIONS = [
  {
    ...
    userID: '1b0fc8a1-cd68-41f6-899e-d0e0676c90bb',
    type: 'Investor',
    name: 'Dr. Alize Donnelly',
    avatar: '/static/mock-images/avatars/avatar_8.jpg',
    message: 'Investor money from',
...
export default function BankingRecentTransitions() {
  ...
  return (
    <>
      <Card>
        <CardHeader title="Danh sách investor" sx={{ mb: 3 }} />
        <Scrollbar>
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>investorType</TableCell>
